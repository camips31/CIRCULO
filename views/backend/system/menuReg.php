                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 mb-md-8 mb-xl-8">
                    <div class="card shadow-sm">
                        ...
                        <div class="collapse show">
                            <!--begin::Form-->
                            <form id="system-form-menu-reg" class="form" action="#" autocomplete="off">
                                <div class="card-body">
                                    <div class="fv-row form-group row mb-5">
                                        ...
                                        <div class="fv-row form-group row mb-5">
                                            <div class="col-md-3">
                                                ...
                                                <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control mb-2 mb-md-0" name="vNameMenu" id="vNameMenu" placeholder="Registrar el Nombre del Menú">
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label">URL Menú
                                                <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control mb-2 mb-md-0" name="vURLMenu" id="vURLMenu" placeholder="Registrar la URL del Menú">
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label">Controlador
                                                <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control mb-2 mb-md-0" name="vControllerActive" id="vControllerActive" value="" placeholder="Registrar el Controlador del Menú">
                                            </div> 
                                            <div class="col-md-3">
                                                <label class="form-label">Método
                                                <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control mb-2 mb-md-0" name="vMethodActive" id="vMethodActive" value="" placeholder="Registrar el Método del Menú">
                                            </div>                                            
                                        </div>
                                        <div class="fv-row form-group row mb-5">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <textarea class="form-control mb-2 mb-md-0" id="vDescMenu" name="vDescMenu" rows="3" placeholder="Registre detalladamente la función del menú"></textarea>                                                
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <!--begin::Actions-->
                                    <button id="system-form-menu-reg-submit" type="submit" class="btn btn-primary">
