											...
											<div class="card shadow-sm">
												<div class="card-header collapsible cursor-pointer rotate" data-bs-toggle="collapse" data-bs-target="#kt_docs_card_collapsible">
                                                    ...
                                                    <div class="d-flex align-items-center position-relative my-1">
                                                        ...
                                                        <input type="text" id="searchMainAccountingBooksTable" data-kt-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Búsqueda..." />
                                                    </div>
                                                    <!--end::Search-->													
												</div>
                                                        ...
                                                        <table class="table table-row-bordered gy-5" id="datatable_mainaccountingbooks2">
                                                            ...
                                                            <?Php
                                                                if(isset($this->vDataMainAccountingBook) && count($this->vDataMainAccountingBook)):
                                                                    ...
                                                                    $vTotalDebe = $vTotalHaber = $vTotalSaldo = 0;
                                                                    ...
                                                                    for($i=0;$i<count($this->vDataMainAccountingBook);$i++):
                                                                        echo '<tr code="'.$this->vDataMainAccountingBook[$i]['n_codvoucher'].'">';
																			...
																			if($this->vDataMainAccountingBook[$i]['n_taccount'] == 1){
																				echo '<td>'.number_format($this->vDataMainAccountingBook[$i]['n_voucheramount'], 2,',','.').'</td>';
																				echo '<td>0</td>';
															...
															<tfoot>
																<tr class="fw-bold fs-6">
																	...
																	<th colspan="3" class="text-nowrap align-end"></th>
																</tr>
															</tfoot>															
                                                        </table>
													</div>
