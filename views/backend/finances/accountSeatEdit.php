                                        ...
                                        for($i=0;$i<count($this->DataVouchersList);$i++):
                                            echo '<tr code="'.$this->DataVouchersList[$i]['n_codvoucher'].'">';
                                                ...
                                                if($this->DataVouchersList[$i]['n_taccount'] == 1){
                                                    echo '<td>'.$this->DataVouchersList[$i]['n_voucheramount'].'</td>';
                                                    echo '<td>0</td>';
                                                    $vTotalDebe = $vTotalDebe + $this->DataVouchersList[$i]['n_voucheramount'];
                                                } else if($this->DataVouchersList[$i]['n_taccount'] == 2){
                                                    echo '<td>0</td>';
                                                    echo '<td>'.$this->DataVouchersList[$i]['n_voucheramount'].'</td>';    
                                                    $vTotalHaber = $vTotalHaber + $this->DataVouchersList[$i]['n_voucheramount'];
                                                }
