    ...
    columnDefs: [
      {
        ...
        //"data": null,
        defaultContent:
          '<button class="btn btn-sm btn-clean btn-icon" id="BtnFinancesRecordPartner"><i class="la la-coins"></i></button><button class="btn btn-sm btn-clean btn-icon" id="BtnDeletePartner"><i class="la la-trash"></i></button>',
      },
      {
        width: "75px",
        targets: 2,
        render: function (data, type, full, meta) {
          var status = {
            1: { title: "Activo Presente", class: " badge badge-light-info" },
            2: { title: "Emérito Presente", class: " badge badge-light-success" },
            3: { title: "Corporativo", class: " badge badge-light-danger" },
            4: { title: "Activo Ausente", class: " badge badge-light-warning" },
            5: { title: "Emérito Ausente", class: " badge badge-light-primary" },
            6: { title: "Especial", class: " badge badge-light-secondary" },
            7: { title: "Diplomático", class: " badge badge-light-info" },
            8: { title: "Congelado", class: " badge badge-light-success" },
            9: { title: "Exento", class: " badge badge-light-danger" },
            10: { title: "Concesionario", class: " badge badge-light-warning" },
            11: { title: "Emérito No Aportante", class: " badge badge-light-primary" },
            12: { title: "Exento", class: " badge badge-light-secondary" },
          };
...
$('#datatable_partnerdebtreconciliation tbody').on( 'click', 'button', function () {
  ...
  return {
    ...
    init: function () {
      ...
      handleDataTableDebts();
      handleRecordFinancesPartnerTable();
      handlePartnerDebtReconciliation();
    },
  };
})();
