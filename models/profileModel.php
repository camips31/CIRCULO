		...
		public function __construct(){
            ...
            public function getProfileExists($vProfileName){
                ...
                $vResultProfileExists = $this->vDataBase->query("SELECT
                                                                    ...
                                                                    FROM tb_cdlu_profiles
                                                                        WHERE tb_cdlu_profiles.c_profilename = '$vProfileName';");
            ...
            public function getNames($vCodProfile){
                ...
                $vResultNames = $this->vDataBase->query("SELECT
                                                                ...
                                                                FROM tb_cdlu_profiles
                                                                    WHERE tb_cdlu_profiles.n_codprofile = $vCodProfile;");
            ...
            public function getProfileCodeFromUserCode($vUserCode){
                ...
                $vResultProfileCodFromProfileName = $this->vDataBase->query("SELECT
                                                                                tb_cdlu_profiles.n_codprofile
                                                                            FROM tb_cdlu_profiles
                                                                                WHERE tb_cdlu_profiles.n_coduser = $vUserCode;");
                return $vResultProfileCodFromProfileName->fetchColumn();
                $vResultProfileCodFromProfileName->close();            
            }
            public function getProfileName($vCodProfile, $vCodUser){
                ...
                $vResultProfileName = $this->vDataBase->query("SELECT
                                                                ...
                                                                FROM tb_cdlu_profiles
                                                                WHERE tb_cdlu_profiles.n_codprofile = $vCodProfile
                                                                AND tb_cdlu_profiles.n_coduser = $vCodUser;");
            ...
            public function profileRegister($vUserCode, $vProfileName, $vName, $vLastName, $vProfileType, $vActive){
                ...
                $vResultProfileRegister = $this->vDataBase->prepare("INSERT INTO tb_cdlu_profiles(n_coduser, c_profilename, c_name, c_lastname, n_profiletype, n_active, c_usercreate, d_datecreate)
            ...
            {            
                ...
                $vResultUpdateProfileInfo = $this->vDataBase->prepare("UPDATE
                                                                        tb_cdlu_profiles
                                                                    SET tb_cdlu_profiles.c_name = :c_name,
                                                                        tb_cdlu_profiles.c_lastname = :c_lastname,
                                                                        tb_cdlu_profiles.c_description = :c_description,
                                                                        tb_cdlu_profiles.c_address = :c_address,
                                                                        tb_cdlu_profiles.c_whatsapp = :c_whatsapp,
                                                                        tb_cdlu_profiles.c_usermod = :c_usermod,
                                                                        tb_cdlu_profiles.d_datemod = :d_datemod
                                                                    WHERE tb_cdlu_profiles.n_codprofile = :n_codprofile;")
                                ->execute(
                                            array(
                                                ':c_name'=>$vName,
                                                ':c_lastname'=>$vLastName,
