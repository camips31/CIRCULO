...
class moduleModel extends IdEnModel
	{
		...
		public function getModule()
			{
				$vResultGetModule = $this->vDataBase->query("SELECT * FROM tb_cdlu_modules;");
        ...
        public function getModuleExists($vCodModule)
			{
				...
				$vResultGetModule = $this->vDataBase->query("SELECT COUNT(*) FROM tb_cdlu_modules WHERE n_codmodule = $vCodModule;");
        ...
        public function getMethodsFromCodModule($vCodeMenu)
			{
				...
				$vResultGetMethodsFromCodModule = $this->vDataBase->query("SELECT * FROM tb_cdlu_menu WHERE n_parent = $vCodeMenu;");
		...
		public function insertModule($vCodeMenu, $vModuleName, $vModuleRole, $vStatus, $vActive){
            ...
            $vResultInsertModule = $this->vDataBase->prepare("INSERT INTO tb_cdlu_modules(n_codmenu, c_name_module,c_role_module,n_status,n_active,c_usercreate,d_datecreate)
