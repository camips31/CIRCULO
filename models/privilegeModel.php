...
class privilegeModel extends IdEnModel
	{
		...
		public function getPrivilege()
			{
				$vResultGetPrivilege = $this->vDataBase->query("SELECT * FROM tb_cdlu_privileges;");
        ...
        public function getPrivilegeExists($vCodPrivilege)
			{
				...
				$vResultGetPrivilege = $this->vDataBase->query("SELECT COUNT(*) FROM tb_cdlu_privileges WHERE n_codprivilege = $vCodPrivilege;");
		...
		public function insertPrivilege($vNamePrivilege, $vRolePrivilege, $vStatus, $vActive){
            ...
            $vResultInsertPrivilege = $this->vDataBase->prepare("INSERT INTO tb_cdlu_privileges(c_name_privilege,c_role_privilege,n_status,n_active,c_usercreate,d_datecreate)
