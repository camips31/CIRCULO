...
class usersModel extends IdEnModel
	{
        ...
        public function getUsers(){
            ...
            if($vUserCode == 1){
                $vResultUsers = $this->vDataBase->query("SELECT
                                                    ...
                                                    tb_cdlu_users.n_tnc,
                                                    tb_cdlu_users.n_activationcode,
                                                    tb_cdlu_users.n_status,
                                                    tb_cdlu_users.n_active,
                                                    (SELECT
                                                            tb_cdlu_profiles.n_codprofile
                                                        FROM tb_cdlu_profiles
                                                            WHERE tb_cdlu_profiles.n_coduser = tb_cdlu_users.n_coduser) as n_codprofile,                                                        
                                                    IFNULL((SELECT
                                                            tb_cdlu_profiles.c_profile_img
                                                        FROM tb_cdlu_profiles
                                                            WHERE tb_cdlu_profiles.n_coduser = tb_cdlu_users.n_coduser), 'blank.png') as c_profile_img
                                                FROM tb_cdlu_users;");
                ...
                $vResultUsers = $this->vDataBase->query("SELECT
                                                    ...
                                                    IFNULL((SELECT
                                                        ...
                                                        FROM tb_cdlu_profiles
                                                            WHERE tb_cdlu_profiles.n_coduser = tb_cdlu_users.n_coduser), 'blank.png') as c_profile_img
                                                FROM tb_cdlu_users
                                                    WHERE tb_cdlu_users.n_coduser <> 1;");
                return $vResultUsers->fetchAll();
                $vResultUsers->close();
            }            
        }
            ...
            $vResultUser = $this->vDataBase->query("SELECT
                                                        ...
                                                        FROM tb_cdlu_users, tb_cdlu_profiles
                                                            WHERE tb_cdlu_users.n_coduser = tb_cdlu_profiles.n_coduser
                                                                AND tb_cdlu_users.n_coduser = $vCodeUser;");
        ...
        public function getUserNameExists($vEmail){
            ...
            $vResultUserEmailExists = $this->vDataBase->query("SELECT
                                                                    COUNT(*)
                                                                FROM tb_cdlu_users
                                                                    WHERE tb_cdlu_users.c_username = '".$vEmail."';");
            return $vResultUserEmailExists->fetchColumn();
            $vResultUserEmailExists->close();            
        }
		...
		public function getAccountStatusUserCode($vCodUser)
			{
				...
				$vResultGetUserAccountStatus = $this->vDataBase->query("SELECT
                                                                                tb_cdlu_users.n_active
                                                                            FROM tb_cdlu_users
                                                                                WHERE tb_cdlu_users.n_coduser = $vCodUser;");
				return $vResultGetUserAccountStatus->fetchColumn();
				$vResultGetUserAccountStatus->close();
			}    
        public function getCodUserFromCodFacebookUser($vCodFacebookUser){
            ...
            $vResultCodUser = $this->vDataBase->query("SELECT
                                                                tb_cdlu_users.n_coduser
                                                            FROM tb_cdlu_users
                                                                WHERE tb_cdlu_users.c_rrss_id = '".$vCodFacebookUser."';");
        ...
        public function getCodUserFromCodGoogleUser($vCodGoogleUser){
            ...
            $vResultCodUser = $this->vDataBase->query("SELECT
                                                                tb_cdlu_users.n_coduser
                                                            FROM tb_cdlu_users
                                                                WHERE tb_cdlu_users.c_rrss_id = '".$vCodGoogleUser."';");
            return $vResultCodUser->fetchColumn();
            $vResultCodUser->close();            
        }
        ...
        public function getPrivileges($vCodUser, $vUserRole){
            ...
            $vResultPrivileges = $this->vDataBase->query("SELECT
                                                            ...
                                                            FROM tb_cdlu_users
                                                                WHERE tb_cdlu_users.n_coduser = $vCodUser
                                                                    AND tb_cdlu_users.c_userrole = $vUserRole;");
        ...
        public function getFacebookProfileImage($vCodUser){
            ...
            $vResultFacebookProfileImage = $this->vDataBase->query("SELECT
                                                                        tb_cdlu_facebookusers.c_picture
                                                                    FROM tb_cdlu_users, tb_cdlu_facebookusers
                                                                        WHERE tb_cdlu_users.n_coduser = tb_cdlu_facebookusers.c_rrss_id
                                                                            AND tb_cdlu_users.n_coduser = $vCodUser;");
        ...
        public function getGoogleProfileImage($vCodUser){
            ...
            $vResultGoogleProfileImage = $this->vDataBase->query("SELECT
                                                                        tb_cdlu_googleusers.c_picture
                                                                    FROM tb_cdlu_users, tb_cdlu_googleusers
                                                                        WHERE tb_cdlu_users.n_coduser = tb_cdlu_googleusers.n_codgoogleuser
                                                                            AND tb_cdlu_users.n_coduser = $vCodUser;");
		...
		public function userRegister($vUserFacebookId, $vUsername, $vPassword1, $vPassword2, $vEmail, $vRole, $vActivationcode, $vStatus, $vActive){
				...
				$vResultUserRegister = $this->vDataBase->prepare("INSERT INTO tb_cdlu_users(c_rrss_id, c_username, c_pass1, c_pass2, c_email, c_userrole, n_activationcode, n_status, n_active, c_usercreate, d_datecreate)
		...
		public function updateUser($vCodUser, $vEmail, $vRole, $vStatus, $vActive)
            {            
                ...
                $vResultUpdateUser = $this->vDataBase->prepare("UPDATE
                                                                        tb_cdlu_users
                                                                    SET tb_cdlu_users.c_username = :c_username,
                                                                        tb_cdlu_users.c_email = :c_email,
                                                                        tb_cdlu_users.c_userrole = :c_userrole,
                                                                        tb_cdlu_users.n_status = :n_status,
                                                                        tb_cdlu_users.n_active = :n_active,
                                                                        tb_cdlu_users.c_usermod = :c_usermod,
                                                                        tb_cdlu_users.d_datemod = :d_datemod
                                                                    WHERE tb_cdlu_users.n_coduser = :n_coduser;")
                                ->execute(
                                            array(
                                                ':c_username'=>$vEmail,
                                                ':c_email'=>$vEmail,
            ...
            {            
                ...
                $vResultUpdateAccount = $this->vDataBase->prepare("UPDATE
                                                                            tb_cdlu_users
                                                                        SET tb_cdlu_users.c_email = :c_email,
                                                                            tb_cdlu_users.c_usermod = :c_usermod,
                                                                            tb_cdlu_users.d_datemod = :d_datemod
                                                                        WHERE tb_cdlu_users.n_coduser = :n_coduser;")
                                ->execute(
		...
		public function updateUserPassword($vCodUser, $vNewPassword, $vNewRePassword)
            {            
                ...
                $vResultUpdatePassword = $this->vDataBase->prepare("UPDATE
                                                                            tb_cdlu_users
                                                                        SET tb_cdlu_users.c_pass1 = :c_pass1,
                                                                            tb_cdlu_users.c_pass2 = :c_pass2,
                                                                            tb_cdlu_users.c_usermod = :c_usermod,
                                                                            tb_cdlu_users.d_datemod = :d_datemod
                                                                        WHERE tb_cdlu_users.n_coduser = :n_coduser;")
                                ->execute(
        ...
        public function updateUserActive($vCodUser, $vActive)
            {            
                ...
                $vResultUpdatePassword = $this->vDataBase->prepare("UPDATE
                                                                            tb_cdlu_users
                                                                        SET tb_cdlu_users.n_active = :n_active,
                                                                            tb_cdlu_users.c_usermod = :c_usermod,
                                                                            tb_cdlu_users.d_datemod = :d_datemod
                                                                        WHERE tb_cdlu_users.n_coduser = :n_coduser;")
                                ->execute(
        ...
        public function updateModuleUser($vCodUserToAssign, $vModuleAssigned)
            {            
                ...
                $vResultUpdateModuleUser = $this->vDataBase->prepare("UPDATE
                                                                            tb_cdlu_users
                                                                        SET tb_cdlu_users.c_userrole = :c_userrole,
                                                                            tb_cdlu_users.c_usermod = :c_usermod,
                                                                            tb_cdlu_users.d_datemod = :d_datemod
                                                                        WHERE tb_cdlu_users.n_coduser = :n_coduser;")
                                ->execute(
